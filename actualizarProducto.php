...
<body>
    ...
    <?php
    include("../forrajes_Manuelin/conexiones/conexion.php");
...
FROM
    ...
    <!--FORMULARIO--->
    <form action="../forrajes_Manuelin/funciones/actualizaProducto.php" method="POST">


        <div class="mb-3">
            <label for="" class="form-label">Codigo Producto</label>
            <input type="text" class="form-control" name="txtIdProducto" id="IdProducto" required maxlength="6" value="<?php echo $documento['idProducto'] ?>">
        </div>

        <div class="mb-3">
            <label for="" class="form-label">Descripcion</label>
            <input type="text" class="form-control" name="txtDescripcion" id="Descripcion"  required value="<?php echo $documento['DescripcionProduceto'] ?>">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Precio Final</label>
            <input type="number" class="form-control" name="txtPrecioFinal" id="PrecioFinal" required value="<?php echo $documento['PrecioFinal'] ?>">
        </div>
        <div class="form-group mb-3">
            <label for="exampleFormControlInput1">Categoria</label>
            <select class="form-select" aria-label="Default select example" name="cmbCategoria" id="idCategoria">
                <option value='<?php echo $documento['IdCategoria'] ?>'><?php echo $documento['NombreCategoria'] ?></option>
                <?php
        ...
        <div class="form-group mb-3">
            ...
            <select class="form-select" aria-label="Default select example" name="cmbMarca" id="idMarca">
                <option value='<?php echo $documento['IdMarca'] ?>'><?php echo $documento['NombreMarca'] ?></option>
                <?php
                include("./conexiones/conexion.php");
