...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('assets/img/venta.jpg')">
        ...
        <!-- Main Content-->
        <main class="mb-4">
        <form action="../forrajes_Manuelin/funciones/insertarVentaa.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="txtCantidad" id="Cantidad" placeholder="" required>
        </div>

        <div class="mb-3">
            <label for="" class="form-label">Pecio Venta</label>
            <input type="number" class="form-control" name="txtVenta" id="PrecioVenta" placeholder="" required maxlength="10">
        </div> 

        <div class="mb-3">
            <label for="" class="form-label">Fecha y Hora</label>
            <input type="date" class="form-control" name="txtFechaHoraVenta" id="FechaHoraVenta" placeholder="" required>
        </div>
         
        <div class="form-group mb-3">
            <label for="exampleFormControlInput1">Producto</label>
            <select class="form-select" aria-label="Default select example" name="cmbProducto" id="Producto">
        ...
        <div class="mb-3">
            ...
            <a class="btn btn-danger" href="./venta.php" role="button">Cancelar</a>
